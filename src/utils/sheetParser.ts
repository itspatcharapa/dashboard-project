import { SheetRow, DashboardData } from "../types";
...
export function processRows(rows: SheetRow[]): DashboardData {
...
export function parseCSVAndMap(csvContent: string): DashboardData {
  ...
  return processRows(records);
}

export const fallbackRows: SheetRow[] = [
  {
    projectId: "P001",
